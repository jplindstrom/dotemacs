...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cask" '("cask-" "package-directory-recipe")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cask-bootstrap" '("cask-bootstrap-dir")))
