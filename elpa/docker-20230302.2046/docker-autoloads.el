...
;;;***

;;;### (autoloads nil "docker-context" "docker-context.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from docker-context.el
 (autoload 'docker-contexts "docker-context" nil t)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "docker-context" '("docker-context")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "docker-utils" '("docker-")))
...
;;;***

;;;### (autoloads nil nil ("docker-faces.el" "docker-group.el" "docker-pkg.el"
;;;;;;  "docker.el") (0 0 0 0))
