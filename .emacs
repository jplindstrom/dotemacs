...
(custom-set-faces
 ...
 '(terraform--resource-name-face ((t (:foreground "dark green" :underline t))) t)
 '(terraform--resource-type-face ((t (:foreground "medium sea green" :underline t))) t))
